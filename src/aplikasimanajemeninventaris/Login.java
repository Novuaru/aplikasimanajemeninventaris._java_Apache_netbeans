...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplikasimanajemeninventaris/gambar/logo-icon-person-on-white-background-free-vector.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(707, 357));
    ...
    try {
           ...
           String sql = "SELECT * FROM login WHERE Username='" + txUsername.getText()
                   + "' and Password='" + new String(txPassword.getPassword()) + "'";
           ResultSet r = s.executeQuery(sql);

           if (r.next()) {
               JOptionPane.showMessageDialog(null, "Login Berhasil");
               this.dispose(); // close the login form
               ManajemenBarang menu = new ManajemenBarang();
               menu.setVisible(true); // open the Menu form
           } else {
